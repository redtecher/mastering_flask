...
def home(page=1):
    ...
    return render_template('home.html',posts= posts,rencent=recent,top_tags=top_tags)
...
def post(post_id):
    ...
    return render_template('post.html',post=post,tags=tags,recent=recent,top_tags=top_tags,comments=comments)
